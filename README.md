...
- [Документация Kafka Producer](scripts/README.md) - подробности о скрипте-эмуляторе
- [Kafka UI Guide](http://localhost:8081/) - веб-интерфейс для Kafka
- [API Documentation](docs/api.md) - описание REST API (если есть)

---

**Проект готов к production-использованию!** 🚀

*Создано как демонстрация микросервисной архитектуры с Kafka, PostgreSQL и Go.*
